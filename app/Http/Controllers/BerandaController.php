...
class BerandaController extends Controller
{
    ...
    public function sendWhatsAppNotification($admin, $trans,$plainPassword = null)
    {
        ...
        if (Auth::guard('admin')->check() == null) {
            ...
            . "🔗 Login: {$loginUrl}\n\n"
            . "Silakan login di website kami untuk menikmati paket anda dan nikmati fiturnya! 💪\n";
        }

        $message .= "\nTerima kasih!\nSalam, Tim Pidana Hukum ❤️";
    ...
    public function registerStore(Request $request)
    {
        try {
            ...
            $message = "Halo {$admin->name},\n\n"
                . "Terima kasih telah bergabung dengan *Pidana Hukum* 🎉.\n\n"
                . "Berikut adalah akun Anda:\n"
                . "👤 Username: *{$admin->username}*\n"
                . "🔑 Password: *{$plainPassword}*\n\n"
                . "Silakan login di website kami dan nikmati fiturnya! 💪\n\n"
                . "Salam,\nTim Pidana Hukum ❤️";
